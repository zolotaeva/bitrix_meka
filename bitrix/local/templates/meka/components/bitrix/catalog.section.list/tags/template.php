...
?>
	...
	<div class="catalog__tags tags" id="<? echo $this->GetEditAreaId($arResult['SECTION']['ID']); ?>">
						...
						foreach ($arResult['SECTIONS'] as &$arSection)
						{
							...
							if (false === $arSection['PICTURE'])
								...
								if($arSection['PICTURE']['ID'] != ''){
									$img = CFile::ResizeImageGet($arSection['PICTURE']['ID'], array('width'=>60, 'height'=>60), BX_RESIZE_IMAGE_PROPORTIONAL, true); 
									$img = $img['src'];
								}else{
									$img = $this->GetFolder().'/images/noimage_min.png';
								}
								
								?>
								<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="tag" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
									<span class="tag__img"><img src="<? echo $img; ?>" alt="<? echo $arSection['PICTURE']['ALT']; ?>"></span>
									<span class="tag__ttl"><? echo $arSection['NAME']; ?></span>
								</a>
