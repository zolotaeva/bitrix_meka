					...
					case 'TILE':
						foreach ($arResult['SECTIONS'] as &$arSection)
						{
							...
							if (false === $arSection['PICTURE'])
								...
								?>
								<div class="catalog__col col-sm-6 col-md-6 col-lg-3">
									<a class="catalog__item" href="<? echo $arSection['SECTION_PAGE_URL']; ?>" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
										<span class="catalog__item-title"><? echo $arSection['NAME']; ?></span>
